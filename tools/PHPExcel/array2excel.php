...
class ExcelReport extends View {
  ...
  function extraer_informe($array, $subtitulo) {
    ...
    $objPHPExcel->getProperties()->setCreator("Syntecom") 
                                 ->setLastModifiedBy("Syntecom") 
                                 ->setTitle("Informes Syntecom")
                                 ->setSubject("Informes Syntecom")
                                 ->setDescription("Informes Syntecom")
                                 ->setKeywords("informes Syntecom")
                                 ->setCategory("Informes Syntecom");
    
    $tituloReporte = "Reportes Syntecom";
    ...
    $objPHPExcel->getActiveSheet()->setTitle("InfSyntecom");
    $objPHPExcel->setActiveSheetIndex(0);
